...
export interface DevRole {
  ...
  readonly platformRole: 'user' | 'developer' | 'admin';
...
export const DEV_ROLES: readonly DevRole[] = [
  {
    ...
    email: 'dev-admin@roles.localhost', title: '平台管理员', summary: '查看管理空间、租户与全局配置。', platformRole: 'admin', isAdmin: true, memberRole: null,
  },
  {
    key: 'developer', sub: 'dev-role-developer', username: 'dev-developer', name: '开发环境 · 开发者',
    email: 'dev-developer@roles.localhost', title: '项目开发者', summary: '进入选定项目，开发、预览并管理版本。', platformRole: 'developer', isAdmin: false, memberRole: 'developer',
  },
  {
    key: 'tester', sub: 'dev-role-tester', username: 'dev-tester', name: '开发环境 · 测试者',
    email: 'dev-tester@roles.localhost', title: '用户 · Beta 试用', summary: '在首页看到选定应用的 Beta 标签，并直接试用。', platformRole: 'user', isAdmin: false, memberRole: 'tester',
  },
  {
    key: 'member', sub: 'dev-role-member', username: 'dev-member', name: '开发环境 · 普通成员',
    email: 'dev-member@roles.localhost', title: '用户', summary: '没有项目成员关系，验证公开能力与空状态。', platformRole: 'user', isAdmin: false, memberRole: null,
  },
] as const;
