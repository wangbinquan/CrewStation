...
| UX-AT-25 | E11、E33、E37、E38；新增设置九项、诊断三项、管理十三项、创建三步骤及列表／概览五尺寸；共享表格长说明行由 397px 降至 128px | 资源总览能力表格仍有最高 1297px 的行；继续修复可读性并补齐全部关键页面，现有无整页溢出的尺寸子集不代表全部通过 |
| UX-AT-26 | E8、E11、E33、E37、E38；真实页签键盘／缩窄、错误字段聚焦、表格方向键滚动和右侧编辑焦点可达，新建向导错误及放弃输入；已挂载终端主题回归 | 继续补齐实浏览器系统明暗主题、所有关键控件焦点可见与全程键盘操作 |
