...
| UX-AT-25 | E11、E33、E37，开发页与市场／项目／概览／发布准备／日志／调用链尺寸子集，接入列表／发布详情 320px；修复缩窄后选中标签隐藏 | 继续补齐全部关键页面在 1280×720、1024、768、390、320 下的当前量测，现有子集不代表全部通过 |
| UX-AT-26 | E8、E11、E33、E37，真实页签方向键／Home／End／首尾循环与错误字段聚焦，缩放不抢输入焦点；已挂载终端主题回归 | 继续补齐实浏览器系统明暗主题、所有关键控件焦点可见与全程键盘操作 |
