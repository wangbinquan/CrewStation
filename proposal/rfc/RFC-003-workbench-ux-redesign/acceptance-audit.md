...
| UX-AT-25 | E11、E33、E37–E39；设置、诊断、管理、创建及列表／概览尺寸子集；共享表格密度与 CopyValue 内容挤压已修复，资源操作表最坏行 1297px→123px，中英文各五尺寸 | 继续补齐其余关键页面的完整尺寸操作；当前子集不代表全部通过 |
| UX-AT-26 | E8、E11、E33、E37–E39；页签键盘／缩窄、错误字段焦点、表格方向键与横向复制按钮焦点，新建向导错误／放弃输入；中英文复制状态位置和已挂载终端主题回归 | 继续补齐实浏览器系统明暗主题、所有关键控件焦点可见与全程键盘操作 |
