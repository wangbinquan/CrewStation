...
> 2026-09-14；共享 console 已更新为 `49e64ccc76f9b8b966cc34f0a9a422ecbb5a412e`，后端与任务镜像仍以 `3d1ce5181a11787e3629fea4021f0130e734912d` 为基准。Mac 已恢复可操作，第四十四至四十五批完成无会话提示复验、真实离线恢复、OpenCode 问题与拒绝、发布页后台完成提示。镜像与原会话保留已核对。任务和标准沿用 [plan.md](plan.md)，没有删减范围。
...
| UX-AT-34 | E2、E17，detach、名册、真实断网重载后原进程附着 | 显示窗／重进已实看；专用容器重建后不得伪称原进程仍在线的实际旅程待补 |
