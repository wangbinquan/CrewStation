...
> In Progress · 2026-09-18 作者设定会话目标「完整实现RFC并提交上库」，本 RFC 据此进入实施。产品规则来自作者 2026-09-18 五轮会话裁定（§2）；§13 的 P1–P8 与 ADR-0005 **未经作者逐条确认**，实施先按文中提议做法进行，作者复核时可以改判。RFC-004 按作者裁定 C8 置为 Superseded（§9）。进度与证据见 [plan.md](plan.md) 的实施说明。
