...
| [RFC-010](./RFC-010-cluster-management/proposal.md) | 集群资源管理：项目与平台内置资源的数量、状态、归属和 Pod 用途，受控重启／扩缩／删除与操作记录 | In Progress · RBAC 已批准应用，完整清单／专用项目真实管理动作与浏览器验收通过；三项实机补正已完成，最终发布门禁收口中，见 [证据](./RFC-010-cluster-management/acceptance.md) |
