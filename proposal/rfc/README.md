...
| [RFC-004](./RFC-004-admin-agent-runtime/proposal.md) | 管理员维护 Claude Code／OpenCode 运行配置与版本，租户按算力档位启动并自动加载 | Draft · 2026-09-14 作者明确配置归管理员、租户使用；三件套与 ADR-0004 待审，尚未实现 |
