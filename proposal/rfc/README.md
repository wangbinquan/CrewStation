...
| [RFC-019](./RFC-019-deployment-topology/proposal.md) | 部署与运行形态图：项目概览缩略与运行诊断全图、集群管理拓扑页签（系统层／项目层／Pod 层），视觉借鉴 Archify、工作台自绘 SVG | Draft · 2026-09-22 原型评审中：交互设计稿与 Archify 对照图见 [prototype-review.md](./RFC-019-deployment-topology/prototype-review.md)；三件套待作者看过原型后再写 |
