...
| [RFC-018](./RFC-018-remove-egress-allowlist/proposal.md) | 下线出站 FQDN 白名单：删除条目／申请／被阻记录与 APIProxy 受控出站通道，接入容器直连上游，平台不再以域名约束出站 | Draft · 2026-09-22 作者裁定「这个能力可以下掉，不需要有这个约束」；能力影响清单八项与 Q1（服务槽出向范围）／Q2（遗留 schema）待作者逐项确认，批准前不改代码 |
