...
| [RFC-020](./RFC-020-project-workspace-ia/proposal.md) | 项目工作台信息架构重构：左栏按数字人生命周期排序、二级导航统一为分组导航、开发工作区的预览／代码／变更／数据／参考／会话改为终端旁的工具面板、发布记录合并为带人名的时间线、主题各归一处 | Draft · 2026-09-23 · 作者反馈「项目开发整体界面逻辑太乱」后实机审查 29 个地址并出三件套与设计稿；待作者裁定 proposal §8 的 D1–D7，裁定前不改代码 |
