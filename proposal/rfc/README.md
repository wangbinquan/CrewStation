...
| [RFC-010](./RFC-010-cluster-management/proposal.md) | 集群资源管理：项目与平台内置资源的数量、状态、归属和 Pod 用途，受控重启／扩缩／删除与操作记录 | In Progress · 2026-09-20 已批准实现与提交；代码首笔 `b7fb3e5`，共享门禁与发布待收口；本机 RBAC 审批阻塞动作验收，见 [证据](./RFC-010-cluster-management/acceptance.md) |
