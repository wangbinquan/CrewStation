...
| [RFC-019](./RFC-019-deployment-topology/proposal.md) | 部署与运行形态图：项目概览缩略与运行诊断全图、集群管理拓扑页签（系统层／项目层／Pod 层），视觉借鉴 Archify、工作台自绘 SVG | In Progress · 2026-09-22 · 作者批准三件套并裁定 §7（成员看与管理员相同的 Pod 投影，动作只在集群管理）。T1–T8、T10 完成（基线 v0.3.8：R55、§14.6、D55、AT-56）；本机部署并实机核对三处入口与接口对账，完整门禁 2060 pass／55 skip／0 fail；宽度 1280／1024／390、键盘、浅色主题的实机复核与 e2e 层因本机 dev-auth 需破窗口恢复而待作者授权，见 [acceptance.md](./RFC-019-deployment-topology/acceptance.md) |
