...
| [RFC-017](./RFC-017-project-resource-management/proposal.md) | 项目资源配置：服务规格范围、开发与 Agent 资源、任务配额及共享规格模板归属 | In Progress · 2026-09-21 实现、本机部署及浏览器验收完成；完整门禁 2072 pass／8 skip／0 fail，远端发布与精确 SHA CI 收尾中，见 [验证](./RFC-017-project-resource-management/plan.md) |
