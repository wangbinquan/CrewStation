...
const PROJECT_DEPTH = [
  {
    capability: '发布与上线：两个槽、试用入口、发布记录时间线',
    suffix: '/release',
    parts: ['准备发布', '正式版本', '待验证版本', '发布记录', '两个版本共用生产数据'],
  },
  {
    capability: '运行与诊断：部署与运行形态、健康状态、日志、告警、事件投递、调用链（2026-09-23 修订 RFC-020 D3 后六个页签）',
    suffix: '/operations',
    parts: ['部署与运行形态', '健康状态', '日志', '告警与通知', '事件投递', '调用链回放'],
  },
  {
    capability: '项目设置：环境变量、应用展示、成员与角色、项目信息、高级',
    suffix: '/settings',
    parts: ['环境变量', '应用展示', '成员与角色', '项目信息', '高级', '新增变量'],
  },
  {
    // RFC-020 D2：原「开发资源」住在开发页的「可使用资源」面板里，放大形态即整页；2026-09-23 按代码怎么用它分四类。
    capability: '开发页可使用资源：调用接口、接收事件、运行环境、Agent 工具',
    suffix: '/dev-session?view=reference&panel=full',
    parts: ['调用接口', '接收事件', '运行环境', 'Agent 工具', '操作详情'],
  },
  {
...
const ADMIN_DEPTH = [
  {
    ...
    path: '/admin',
    parts: ['待处理事项', '待审批 API 申请', '开通失败', '新建数字人'],
  },
  {
