...
export const settingsMessages: MessagesShapedLike<typeof zhCN> = {
  ...
  'admin.settings.autoOffline.description': 'The rollback target left behind by a traffic switch is kept for a while, and preview versions nobody opens are taken offline. The project owner is reminded first and can postpone once reminded.',
  ...
  'admin.settings.autoOffline.hint.reminderLeadHours': 'Hours, 1–720. Must be shorter than both periods above. Owners can postpone only after the reminder.',
