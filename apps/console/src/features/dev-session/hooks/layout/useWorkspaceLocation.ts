 ...
 */
export function useWorkspaceLocation(taskId: string, location: WorkspaceLocation | undefined, roster: NativeTerminalDto[] | undefined, store: WorkspaceLayoutStore, loaded: boolean, hasActivityTarget: boolean, tabName: string, layoutKey: string, narrow = false) {
  ...
  }, [location, loaded, hasActivityTarget, invalid, view, instruction, selected, wantsTerminal, roster, terminal, store, tabName, layoutKey, narrow]);
