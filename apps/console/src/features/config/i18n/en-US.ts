...
export const messages: MessagesShapedLike<typeof zhCN> = {
  ...
  "config.impact.mismatch": "Release records disagree; the comparison is read again automatically.",
  ...
  "config.impact.historyBehind": "Saved history is older than the deployment record; it is read again automatically.",
