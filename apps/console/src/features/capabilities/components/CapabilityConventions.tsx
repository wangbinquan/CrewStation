...
export function CapabilityConventions({ conventions, forwarding, groups = GROUPS, showForwarding = true }: { readonly conventions: Conventions; readonly forwarding: Forwarding; readonly groups?: readonly (keyof Conventions)[]; readonly showForwarding?: boolean }): ReactElement {
  const t = useT();
  return (
    <CapabilitySection title={t('capabilities.conventions.title')} note={t('capabilities.conventions.note')}>
      ...
      */}
      {showForwarding ? <section className={styles.group}>
