...
export function CatalogContent({ projectId, serviceId, isAdmin }: CatalogContentProps): ReactElement {
  ...
  return (
    <div className={styles.stack}>
      ...
      <SwaggerPanel serviceId={serviceId} proxies={proxies.data?.items ?? []} />
    </div>
  );
}
