...
function setup(options: { readonly layout?: WorkspaceLayout; readonly roster?: NativeTerminalDto[] } = {}) {
...
const element = () => <NativeWorkspace projectId="project-1" taskId="task-1" userId="user-1" channel={{ send: async () => ({}), subscribe: () => () => {} }} stream={{ ...INITIAL_STREAM_STATE, status: 'open', runnerConnected: true, generation: 1 }} canDevelop onActivity={() => {}} preview={null} editor={null} changes={null} />;
