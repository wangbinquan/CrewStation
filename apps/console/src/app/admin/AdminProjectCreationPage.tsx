...
export function AdminProjectCreationPage() {
  ...
  return <>
    ...
    <ActionRow>{scope === 'integration' ? <ButtonLink to="/admin/capabilities" search={{ tab: 'integrations' }}>{t('nav.admin.backToIntegrations')}</ButtonLink> : <ButtonLink to="/admin">{t('projects.wizard.backAdmin')}</ButtonLink>}</ActionRow>
