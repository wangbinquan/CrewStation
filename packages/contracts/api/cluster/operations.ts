...
export const ClusterOperationQuerySchema = z.object({ uid: z.string().max(200).optional(), phase: ClusterOperationSchema.shape.phase.optional(), projectId: z.string().optional(), idempotencyKey: z.string().optional(), limit: z.coerce.number().int().min(1).max(100).default(50) });
