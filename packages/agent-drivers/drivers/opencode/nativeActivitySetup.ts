...
export async function setupOpencodeNativeActivity(ctx: AgentSpawnContext, context: DriverLaunchContext, runDir: RunDirectory, env: Record<string, string>): Promise<'unsupported-version' | 'source-error' | undefined> {
