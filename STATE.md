...
接 09-23「第一期（基础）上线」一节。逐步的门禁、CI、部署与实机记录见 `proposal/rfc/RFC-025-resource-center/acceptance.md` §3–§8。本机控制面眼下是 `cs-control-plane:rc025-t12b-20260924`（5e088e66），工作台是 `cs-console:rc025-t10d-20260924`（5fb115ba），平台路由清单已按 de9dcb5b 应用。
