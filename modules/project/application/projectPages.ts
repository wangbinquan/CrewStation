...
const scopeOf = (actor: Actor, q: ProjectPageQuery) => JSON.stringify({ v: 1, userId: actor.userId, isAdmin: actor.isAdmin,
...
export function projectPageUseCases({ uow, users }: ProjectUseCaseDeps) {
