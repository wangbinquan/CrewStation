...
import { authorizedSink } from './authorizedSink';
      ...
      return {
        onMessage: async (raw) => {
          ...
          try {
            ...
            guarded.send(JSON.stringify({ type: 'result', id: command.id, payload }));
          } catch (error) {
