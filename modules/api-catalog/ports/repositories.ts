...
export interface ApiProxyRepository {
  ...
  getByName(proxy: string): Promise<ApiProxy | undefined>;
...
export interface ApiOperationRepository {
  ...
  getByKey(key: string): Promise<ApiOperation | undefined>;
...
export interface ApiGrantRepository {
  get(serviceId: ServiceId, operationKey: string): Promise<ApiGrant | undefined>;
