...
import type { SlotRecordRef } from './ledger';
...
export interface RepositoryScope {
   ...
   */
  readonly ledger?: { sync(slots: ServiceSlots): Promise<void>; slot(serviceId: ServiceId, physical: PhysicalSlot): Promise<SlotRecordRef | undefined> };
}
